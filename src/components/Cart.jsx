  ...
  return (
    <Modal className="cart" open={userProgressCtx.progress === 'cart'}>
      ...
      <ul>
        ...
        <CartItem key={item.id} name={item.name} price ={item.price} quantity={item.quantity} onDecrease={()=>cartCtx.removeItem(item.id)} onIncrease={()=>cartCtx.addItem(item)}></CartItem>
        ))}
      </ul>
